...
class PointGNN(torch.nn.Module):
    def __init__(self, 
        ...
        self.conv1 = PointGNNConv(mlp_h=MLP(MLP_h), mlp_f=MLP(MLP_f), mlp_g=MLP(MLP_g), aggr="max")
        self.conv2 = PointGNNConv(mlp_h=MLP(MLP_h), mlp_f=MLP(MLP_f), mlp_g=MLP(MLP_g), aggr="max")
        self.conv3 = PointGNNConv(mlp_h=MLP(MLP_h), mlp_f=MLP(MLP_f), mlp_g=MLP(MLP_g), aggr="max")
